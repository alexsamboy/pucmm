...
function get_template_A_info(user_info) {
  ...
  str +='<br><font size="2" face="Arial">';
  str += is_valid_data(user_info.job) ? user_info.job : '';
  str +='</font><br><strong>'+ is_valid_data(user_info.pronoun) ? '&nbsp;' + user_info.pronoun : "" + '</strong>';
  str +='<br>Tel.:'+ is_valid_data(user_info.phone) ? user_info.phone +'<br>' : '';
